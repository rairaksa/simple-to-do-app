    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="w-full h-auto py-6 px-6 bg-gray-100 rounded-md shadow-md flex flex-row">
                ...
                <button className="flex-shrink w-auto h-auto py-2 px-8 text-base rounded-r-md bg-blue-600 text-gray-100 hover:bg-blue-800 hover:text-gray-100" onClick={() => handleInsert()}>Add</button>
            </div>
